...
本项目是计算机组成原理、软件工程与编译原理三门课程的联合实验。项目需求方为计算机组成原理课程，需求方代表为刘卫东老师；项目承担方是“编程是一件很危险的事情”（\textit{ProgrammingCanBeVeryDangerous}）小组，组长为计63陈晟祺，成员还包括计64周聿浩和计54姚沛然。
...
本文档中除了具体实现细节外，也描述了项目的原始需求与最终实现的功能，以及项目的开发、测试、集成等流程，可作为计算机系统联合实验第一部分的完整实验报告。
